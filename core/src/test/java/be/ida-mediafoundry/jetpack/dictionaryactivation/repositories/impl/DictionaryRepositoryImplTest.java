package be.ida-mediafoundry.jetpack.dictionaryactivation.repositories.impl;
...
public class DictionaryRepositoryImplTest {
    ...
    public void setUp() throws Exception {
        context.addModelsForPackage("be.ida-mediafoundry.jetpack.dictionaryactivation");
